	...
	return (
		...
		>
			...
			<Tooltip
				arrow
				placement="bottom"
				title="Системное распределение структуры заплыва. Если внесены изменения дорожек и заплывов, система изменит порядок на соответствующий по времени участника."
			>
				<Button
					size="small"
					sx={{
